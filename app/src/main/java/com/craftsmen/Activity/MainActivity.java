...
import com.craftsmen.Fragments.DashboardFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    void setupViewPager(){
        ...
        if (AppController.getInstance().getPrefManager().getUser().getU_type().equals("user")){
            viewPagerAdapter.addFragment(new DashboardFragment_User() , "الرئسيه");

        }else {
            viewPagerAdapter.addFragment(new OrdersFragment() , "الرئسيه");

        }
        viewPagerAdapter.addFragment(new MessageFragment() , "الرسائل ");
        viewPagerAdapter.addFragment(new NotificationFragment() , "الاشعارات");
